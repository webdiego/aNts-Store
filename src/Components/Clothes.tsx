...
const ClothesItem: React.FC<Props> = ({ Item, addToCart }) => {
  return (
    <ClothesContainer initial="hidden"animate="show" variants={titleAnimation}>
      ...
      <motion.img src={Item.img.front} 
      whileHover={{scale:.95, transition:{duration:.2,ease: "easeIn"}}}

      onMouseEnter={(e)=> e.currentTarget.src =Item.img.back }
      onMouseLeave={(e)=>e.currentTarget.src = Item.img.front} 
      alt={Item.name} 
      />
